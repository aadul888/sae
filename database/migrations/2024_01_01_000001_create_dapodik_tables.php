...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('backup_sekolah')) {
        ...
        if (!Schema::hasTable('backup_rombongan_belajar')) {
        ...
        if (!Schema::hasTable('backup_peserta_didik')) {
        ...
        if (!Schema::hasTable('backup_anggota_rombel')) {
        ...
        if (!Schema::hasTable('backup_pembelajaran')) {
