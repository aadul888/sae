...
<div class="content-wrapper">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
        <div>
            <h1 style="font-size: 1.5rem; font-weight: 700; color: var(--text-heading); margin-bottom: 4px;">
                <i class="fas fa-moon" style="color: var(--primary); margin-right: 8px;"></i>
        ...
        @if ($canCreate)
            <div>
                <button type="button" class="btn btn-primary" onclick="openModalRonda()" style="display: flex; align-items: center; gap: 8px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-bottom: 24px;">
        <div class="card" style="padding: 16px; border-left: 4px solid var(--primary);">
            <div style="font-size: 0.8rem; color: var(--text-muted); font-weight: 600; text-transform: uppercase;">Total Kontrol</div>
        ...
        <div class="card" style="padding: 16px; border-left: 4px solid #3b82f6;">
            <div style="font-size: 0.8rem; color: var(--text-muted); font-weight: 600; text-transform: uppercase;">Ronda Malam Ini</div>
            <div style="font-size: 1.6rem; font-weight: 700; color: #3b82f6; margin-top: 4px;">{{ $stats['malam_ini'] }}</div>
        </div>
        <div class="card" style="padding: 16px; border-left: 4px solid #10b981;">
            <div style="font-size: 0.8rem; color: var(--text-muted); font-weight: 600; text-transform: uppercase;">Kondusif</div>
            <div style="font-size: 1.6rem; font-weight: 700; color: #10b981; margin-top: 4px;">{{ $stats['kondusif'] }}</div>
        </div>
        <div class="card" style="padding: 16px; border-left: 4px solid #ef4444;">
            <div style="font-size: 0.8rem; color: var(--text-muted); font-weight: 600; text-transform: uppercase;">Perhatian Khusus</div>
            <div style="font-size: 1.6rem; font-weight: 700; color: #ef4444; margin-top: 4px;">{{ $stats['insiden_keamanan'] }}</div>
        </div>
    </div>
    ...
    <div class="card" style="width: 100%; max-width: 550px; margin: 20px; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="formRonda" method="POST" action="{{ route('dashboard.penjaga.ronda.store') }}"
            ...
            <div style="margin-bottom: 12px;">
                <label class="form-label">Zona / Titik Kontrol <span style="color:red;">*</span></label>
                <input type="text" name="zona_kontrol" id="ronda_zona" class="form-control" placeholder="Contoh: Gerbang Utama, Ruang Guru & TU, Lab Komputer, Gedung Belakang..." required>
            </div>
