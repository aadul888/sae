...
<div class="dash-content-inner">
    ...
    <div class="dash-banner" style="display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap; margin-bottom: 20px;">
        ...
        <div class="dash-banner-actions" style="display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
            @if ($canCreate)
                <button type="button" class="btn btn-primary" id="btnOpenModalJadwal" style="display: inline-flex; align-items: center; gap: 8px; padding: 8px 16px; border-radius: 8px; font-weight: 600;">
                    <i class="fas fa-plus"></i> Jadwalkan Praktik
                </button>
            @endif
        </div>
    </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 14px;">
                <div>
                    ...
                    <div style="font-size: 0.71rem; color: var(--text-muted); margin-top: 4px;">
                        <i class="fas fa-link me-1 text-primary"></i> Data ruang terintegrasi dari <strong>Sarpras &amp; Aset</strong>.
                    </div>
                </div>
                <div>
