...
<head>
    ...
    <style>
        * {
        ...
        /* Info Box Identitas Pegawai (Identik dengan Jadwal KBM) */
        .info-box {
            display: grid;
        ...
        /* Stats Box Ringkasan Kehadiran (Selaras dengan Jadwal KBM) */
        .stats-box {
            display: flex;
            border: 1px solid #e5e7eb;
            background: #f9fafb;
        ...
        /* Tabel Data (Identik dengan .table-rombel di Jadwal KBM) */
        .table-data {
            width: 100%;
